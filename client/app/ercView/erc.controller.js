(function(){
    ...
    ErcController.$inject = ['$scope', '$stateParams', '$log', '$state', '$window', 'erc', 'publications', 'icons', 'header', '$mdSidenav', 'env', 'ngProgressFactory', 'httpRequests', 'login', 'recipient'];
    function ErcController($scope, $stateParams, $log, $state, $window, erc, publications, icons, header, $mdSidenav, env, ngProgressFactory, httpRequests, login, recipient){
